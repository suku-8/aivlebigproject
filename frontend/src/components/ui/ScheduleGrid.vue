            ...
            <div class="table-responsive">
                <v-table>
                    <thead>
                        ...
                        <th>Id</th>
                        <th>FuneralInfoId</th>
                        <th>ScheduleTemplateId</th>
                        <th>ScheduleFilePath</th>
                        <th>ScheduleFileUrl</th>
                        <th>ScheduleStatus</th>
                        <th>ScheduleCreatedAt</th>
                        <th>CustomerId</th>
                        <th>CustomerName</th>
                        <th>CustomerRrn</th>
                        <th>CustomerPhone</th>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="ScheduleTemplateId">{{ val.scheduleTemplateId }}</td>
                            <td class="whitespace-nowrap" label="ScheduleFilePath">{{ val.scheduleFilePath }}</td>
                            <td class="whitespace-nowrap" label="ScheduleFileUrl">{{ val.scheduleFileUrl }}</td>
                            <td class="whitespace-nowrap" label="ScheduleStatus">{{ val.scheduleStatus }}</td>
                            <td class="whitespace-nowrap" label="ScheduleCreatedAt">{{ val.scheduleCreatedAt }}</td>
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">Schedule 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">Schedule 수정</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
                    ...
                    <v-card-text>
                        <div>
                            <Number label="ScheduleId" v-model="selectedRow.scheduleId" :editMode="true"/>
                            <Number label="FuneralInfoId" v-model="selectedRow.funeralInfoId" :editMode="true"/>
                            <Number label="ScheduleTemplateId" v-model="selectedRow.scheduleTemplateId" :editMode="true"/>
                            <String label="ScheduleFilePath" v-model="selectedRow.scheduleFilePath" :editMode="true"/>
                            <String label="ScheduleFileUrl" v-model="selectedRow.scheduleFileUrl" :editMode="true"/>
                            <String label="ScheduleStatus" v-model="selectedRow.scheduleStatus" :editMode="true"/>
                            <Date label="ScheduleCreatedAt" v-model="selectedRow.scheduleCreatedAt" :editMode="true"/>
