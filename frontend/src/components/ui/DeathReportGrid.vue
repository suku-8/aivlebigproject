            ...
            <div class="table-responsive">
                <v-table>
                    <thead>
                        ...
                        <th>Id</th>
                        <th>FuneralInfoId</th>
                        <th>DeathReportTemplateId</th>
                        <th>DeathReportFilePath</th>
                        <th>DeathReportFileUrl</th>
                        <th>DeathReportStatus</th>
                        <th>DeathReportCreatedAt</th>
                        <th>CustomerId</th>
                        <th>CustomerName</th>
                        <th>CustomerRrn</th>
                        <th>CustomerPhone</th>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="DeathReportTemplateId">{{ val.deathReportTemplateId }}</td>
                            <td class="whitespace-nowrap" label="DeathReportFilePath">{{ val.deathReportFilePath }}</td>
                            <td class="whitespace-nowrap" label="DeathReportFileUrl">{{ val.deathReportFileUrl }}</td>
                            <td class="whitespace-nowrap" label="DeathReportStatus">{{ val.deathReportStatus }}</td>
                            <td class="whitespace-nowrap" label="DeathReportCreatedAt">{{ val.deathReportCreatedAt }}</td>
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">DeathReport 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">DeathReport 수정</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
                    ...
                    <v-card-text>
                        <div>
                            <Number label="DeathReportId" v-model="selectedRow.deathReportId" :editMode="true"/>
                            <Number label="FuneralInfoId" v-model="selectedRow.funeralInfoId" :editMode="true"/>
                            <Number label="DeathReportTemplateId" v-model="selectedRow.deathReportTemplateId" :editMode="true"/>
                            <String label="DeathReportFilePath" v-model="selectedRow.deathReportFilePath" :editMode="true"/>
                            <String label="DeathReportFileUrl" v-model="selectedRow.deathReportFileUrl" :editMode="true"/>
                            <String label="DeathReportStatus" v-model="selectedRow.deathReportStatus" :editMode="true"/>
                            <Date label="DeathReportCreatedAt" v-model="selectedRow.deathReportCreatedAt" :editMode="true"/>
